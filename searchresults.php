                ...
                <div class="row">
                    ...
                    <!-- <div class="col-lg-6 col-sm-8 col-xs-12"> -->
                        <?php
                            ...
                            ?>
                        <!-- <form action="searchresults.php?id=$u_id" method="post">
                            <div class="topsearch">
                                <div class="input-group">
                                    ...
                                    <button class="btn btn-group" name="searchb">Search</button>
                                </div>
                            </div>
                        </form> -->
                    <!-- </div> -->
...
<?php
    if (isset($_POST['searchb'])) {
    	$srch = $_POST['srch'];
    	global $con;
    	$sql_src = "SELECT * FROM video WHERE v_title LIKE '%$srch%' || v_desc LIKE '%$srch%' || v_price LIKE '%$srch%'";
        $run = mysqli_query($con, $sql_src);
...
<br>";
        	...
        	echo '<h4><center>No Further Results Found!</center></h4>';
