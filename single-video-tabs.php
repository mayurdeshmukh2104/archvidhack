            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3  col-sm-10 col-xs-12">
                        <div class="h-icons">
                            <?php echo "<h4>Welcome, ".@$_SESSION['login_user'].'</h4>'; ?>
                            ...
                            <a href="logout.php"><i class="cv cvicon-cv-previous" data-toggle="tooltip"  data-placement="top" title="Logout"></i></a>
                        </div>
                    </div>
                    </div>
            </div>
                    ...
                    <?php
                        if (isset($_GET['v_id'])) {
                            ...
                            while ($row = mysqli_fetch_assoc($query)) {
                               ...
                               echo '<video style="width:100%;height:100%;" controls="controls" preload="auto" width="100%" height="100%" id="my-player" class="video-js" data-setup> 
                        <source src='.$v_url.' type="video/mp4; codecs="avc1.42E01E, mp4a.40.2"" id="my-player"></source>
                    </video>';
                            }
...
<!--                                     <h4>Tags :</h4>
                            ...
                            while ($row = mysqli_fetch_assoc($query)) {
                                ...
                                echo '<form action="savedplaylist.php?v_id='.$v_id.'" method="post">
                                <div class="block-list">
